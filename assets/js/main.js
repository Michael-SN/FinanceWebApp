const Modal = {
  // Função que vai acidionar e remover a class active no modal
  toogle() {
    let _modal = document.querySelector('.modal-overlay')
    _modal.classList.contains('active')
...
const DOM = {
  ...
  clearTransactions() {
    // metodo que vai limpar as transações
